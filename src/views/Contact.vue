    ...
    <v-card class="mx-auto mt-8 px-8 py-10 text-center" max-width="750">
      ...
      <v-card-text>
        <v-form ref="form" v-model="valid">
          <v-text-field label="Name" v-model="name" required :rules="nameRules" outlined color="cyan" class="mb-2"></v-text-field>
          <v-text-field label="Email" v-model="email" required :rules="emailRules" outlined color="cyan" class="mb-2"></v-text-field>
          <v-textarea label="Message" v-model="message" required outlined :rules="messageRules" color="cyan" class="mb-2"></v-textarea>
